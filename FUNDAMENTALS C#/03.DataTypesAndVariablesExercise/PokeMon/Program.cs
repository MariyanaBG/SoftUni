...
namespace PokeMon
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //But at the end of the day, the Poke Mon wants to keeps statistics, about how many pokes it has managed to make.
            ...
            while (pokePower >= distance)
            {
                pokePower -= distance;
                targetCount++;
                if ((double)pokePower == halfPower && exhaustionFactor != 0)
                {
